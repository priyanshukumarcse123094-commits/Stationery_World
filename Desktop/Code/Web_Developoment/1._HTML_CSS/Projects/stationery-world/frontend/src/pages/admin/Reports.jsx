    ...
    return (
      <div className="reports-page">
        <div className="card" style={{ textAlign: "center", color: "#dc2626" }}>
          ...
          <p style={{ color: "#7f1d1d", marginBottom: 16 }}>{error}</p>
    ...
    <div className="reports-page">
      ...
      <div className="filters">
        <div className="filter-row">
          <strong style={{ fontSize: 13, color: "#475569", marginRight: 4 }}>Period:</strong>
          ...
          {rangeType === 'week' ? (
            <>
              <input
                ...
                style={{ padding: "8px 12px", borderRadius: 8, border: "1px solid #e8ecf3", fontSize: 13, fontFamily: "Inter, sans-serif" }}
              />
            ...
            <input
              ...
              style={{ width: 100, padding: "8px 12px", borderRadius: 8, border: "1px solid #e8ecf3", fontSize: 13, fontFamily: "Inter, sans-serif" }}
            />
          ) : (
            <input
              type="date"
          ...
          <span style={{ marginLeft: 8, fontSize: 13, color: "#475569" }}>
            {startDate} – {endDate}
          </span>
        </div>
      </div>
      ...
      <div className="weekly-charts-row">
        ...
        <div className="card chart-card">
          ...
          {weeklyLoading ? (
            <div className="chart-empty" style={{ height: 220 }}><div className="reports-loading-spinner" /></div>
          ) : weeklyData.length > 0 ? (
                ...
                <ResponsiveContainer width="100%" height={300}>
                  <PieChart>
                    ...
                    <Tooltip
                      ...
                      contentStyle={{ borderRadius: 8, fontSize: 13, border: "1px solid #e8ecf3" }}
                    />
                  ...
                  <tbody>
                    {filteredProducts.map((p, i) => (
                      <tr key={p.sku || i}>
                        ...
                        <td>
                          <span style={{ background: "#f1f5f9", color: "#475569", padding: "2px 8px", borderRadius: 6, fontSize: 11, fontWeight: 600 }}>
                            {p.category}
                          </span>
                        </td>
                        <td style={{ fontWeight: 700, color: "#2563eb" }}>{fmtNum(p.qtySold)}</td>
          ...
          <div className="summary-col">
            ...
            {statusData.length > 0 && (
              <div className="card" style={{ marginTop: 0 }}>
                ...
                {statusData.map((d, i) => (
                  <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 0", borderBottom: i < statusData.length - 1 ? "1px solid #f1f5f9" : "none" }}>
                    <span style={{ fontSize: 13, color: "#0f172a", display: "flex", alignItems: "center", gap: 6 }}>
                      <span style={{ width: 8, height: 8, borderRadius: "50%", background: STATUS_COLORS[d.status] || "#94a3b8", display: "inline-block", flexShrink: 0 }} />
                      {d.status}
                    </span>
                    <span style={{ fontSize: 11, fontWeight: 700, padding: "2px 8px", borderRadius: 6, background: "#f8fafc", color: "#475569", border: "1px solid #e8ecf3" }}>
              ...
              <div className="card" style={{ marginTop: 0 }}>
                ...
                {demandData.slice(0, 5).map((d, i) => (
                  <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 0", borderBottom: i < 4 ? "1px solid #f1f5f9" : "none" }}>
                    <span style={{ fontSize: 13, color: "#0f172a" }}>{d.name}</span>
                    <span style={{
                      fontSize: 11, fontWeight: 700, padding: "2px 8px", borderRadius: 6,
                      background: d.inStock ? "#f0fdf4" : "#fef2f2",
                      color: d.inStock ? "#16a34a" : "#dc2626",
                      border: `1px solid ${d.inStock ? "#bbf7d0" : "#fecaca"}`
                    }}>
