  ...
  return (
    <div className="cart-container" style={{ maxWidth: 1100, margin: '0 auto' }}>
      ...
      <div className="cart-grid">
          ...
          {items.map(item => {
            ...
            return (
              <div key={item.id} style={{
                ...
                <div style={{ width: 84, height: 84, borderRadius: 10, overflow: 'hidden', flexShrink: 0, background: '#f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  {imgUrl ? (
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 17, fontWeight: 800, color: '#1d4ed8' }}>{fmt(item.priceAtAdd)}<span style={{ fontSize: 11, color: '#9ca3af', fontWeight: 400, marginLeft: 5 }}>each</span></div>
                </div>
        ...
        {/* Summary */}
        <div style={{ background: '#fff', borderRadius: 16, border: '1px solid #e5e7eb', padding: 22, position: 'sticky', top: 20 }}>
          <h3 style={{ margin: '0 0 18px 0', fontSize: 16, color: '#1f2937', fontWeight: 700 }}>Order Summary</h3>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 18 }}>
            ...
            <div style={{ borderTop: '2px solid #f1f5f9', paddingTop: 12, ...SR }}>
              <span style={{ fontWeight: 700, fontSize: 15 }}>Total</span>
              <span style={{ fontWeight: 800, fontSize: 19, color: '#1d4ed8' }}>{fmt(cart.subtotal)}</span>
            </div>
          </div>
            ...
            {checkoutSuccess ? (
              ...
              <>
                ...
                <div style={{ display: 'flex', gap: 10 }}>
                  <button onClick={() => setShowCheckout(false)} disabled={checkoutLoading} style={{ flex: 1, padding: '11px 0', border: '1px solid #d1d5db', borderRadius: 8, background: '#fff', cursor: 'pointer', fontSize: 13, color: '#374151', fontWeight: 500 }}>Cancel</button>
...
const QB = { width: 30, height: 30, borderRadius: 7, border: '1px solid #e5e7eb', background: '#f9fafb', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#374151' };
